...
public class MD5MD5CRCMessageDigest extends MessageDigest {
    ...
    protected byte[] engineDigest() {
        try {
            ...
            System.out.println(Hex.encodeHex(md5DigestBuffer.getData()));
    ...
    private void flushCrcToBuffer() throws IOException {
        ...
        System.out.println(ByteBuffer.wrap(crc).getInt());
        System.out.println(Hex.encodeHex(crc));
        blockChecksumBuffer.write(crc, 0, crcLen);
        System.out.println(Hex.encodeHex(blockChecksumBuffer.getData()));
    ...
    private void calculateMD5OfBlockCrcs() throws IOException {
        ...
        byte[] firstMd5 = md5Digest.digest();
        System.out.println(Hex.encodeHex(firstMd5));
        md5DigestBuffer.write(firstMd5);
        blockChecksumBuffer.reset();
        md5Digest.reset();
        crcCount = 0;
    }
